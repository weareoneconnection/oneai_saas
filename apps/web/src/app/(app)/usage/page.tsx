    ...
    <div className="space-y-6">
      ...
      {!data ? (
        ...
        <>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Agent OS Usage Link</CardTitle>
              <CardDescription>Handoff contracts generated by this account, linked beside normal API requests and costs.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-3 md:grid-cols-4">
                <Stat label="Executions" value={fmtNum(data.executionSummary?.total || 0)} />
                <Stat label="Succeeded" value={fmtNum(data.executionSummary?.succeeded || 0)} />
                <Stat label="Proof received" value={fmtNum(data.executionSummary?.withProof || 0)} />
                <Stat label="Results stored" value={fmtNum(data.executionSummary?.withResult || 0)} />
              </div>
