...
function Msg({
  ...
  return (
    <div className={cn("flex w-full", isUser ? "justify-end" : "justify-start")}>
      <div className={cn("w-full max-w-[760px]", isUser ? "pl-0 sm:pl-10" : "pr-0 sm:pr-10")}>
      ...
      <div className="flex h-full overflow-x-hidden">
        ...
        <section className="flex min-w-0 flex-1 flex-col overflow-x-hidden">
          ...
          <div className="flex-1 overflow-auto overflow-x-hidden">
            <div className="mx-auto max-w-4xl space-y-5 overflow-x-hidden px-3 py-4 sm:px-4 sm:py-6">
